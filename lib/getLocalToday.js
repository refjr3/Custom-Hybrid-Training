...
/** Calendar YYYY-MM-DD in the given IANA zone (falls back to Eastern if invalid). */
export function getCalendarYmdInTimeZone(timeZone = EASTERN_TZ) {
  const tz =
    typeof timeZone === "string" && timeZone.trim() ? timeZone.trim() : EASTERN_TZ;
  try {
...
export function getLocalToday() {
  return getCalendarYmdInTimeZone(EASTERN_TZ);
}

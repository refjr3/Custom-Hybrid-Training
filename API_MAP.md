...
| `/api/strava/refresh` | orphaned | none | Strava `strava_refresh` cookie | Strava `oauth/token` |
...
| `/api/metrics/today` | orphaned | none | `getAccessTokenFromRequest` | Supabase + `resolver.js` |
